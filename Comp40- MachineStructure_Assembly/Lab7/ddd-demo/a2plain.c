...
static int width    (A2Methods_UArray2 uarray2) { return UArray2_width (uarray2); }
static int height   (A2Methods_UArray2 uarray2) { return UArray2_height(uarray2); }
static int size     (A2Methods_UArray2 uarray2) { return UArray2_size  (uarray2); }
static int blocksize(A2Methods_UArray2 uarray2) { (void)uarray2; return 1; }
static A2Methods_Object *at(A2Methods_UArray2 uarray2, int i, int j) {
  return UArray2_at(uarray2, i, j);
}
   
static void map_row_major  (A2Methods_UArray2 uarray2, A2Methods_applyfun apply, void *cl) {
  UArray2_map_row_major(uarray2, (UArray2_applyfun*)apply, cl);
}
static void map_col_major  (A2Methods_UArray2 uarray2, A2Methods_applyfun apply, void *cl) {
