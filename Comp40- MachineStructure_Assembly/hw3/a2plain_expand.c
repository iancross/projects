/* a2plain.c
 * By Ian Cross and Dan Defossez
 * 2/11/13
 * 
 *
 * Methods suite implementation for uarray2 (non blocked)
 */
...
{       /* no need to make structs, etc because the prototype of our apply 
         * function in uarray2 matches the applyfun type 
         */
