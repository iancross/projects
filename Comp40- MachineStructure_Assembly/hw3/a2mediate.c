...
struct a2fun_closure {
        ...
        void *cl;                  // closure that goes with that apply func
...
static void apply_a2methods_using_array2_prototype(int row, int col,
                                                   void *elem, void *cl) 
{
        struct a2fun_closure *f = cl; /* this is the function/closure 
                                       * originally passed
                                       */
                          ...
                          void *cl)
{
        ...
        Array2_map_row_major(array2,
                             apply_a2methods_using_array2_prototype,
                             &mycl);
}
